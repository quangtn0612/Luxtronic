...
// made this file because this is what the textInput should be (100% width), and we should manage the other visuals from the screen's side
// temp fix
function NewTextInput({ icon, edit, ...otherProps }) {
