...
const TechExpandedTicketScreen = ({ navigation }) => {
  ...
  const [customerInfo, setcustomerInfo] = React.useState(
    navigation.getParam("customerInfo")
  );
  const [ticket, setticket] = React.useState(navigation.getParam("item"));
  console.log("customerInfo " + customerInfo);
  const [statusContainerChange, setstatusContainerChange] =
                    ...
                    <View style={styles.statusUpdateContainer}>
                      ...
                      {ticket.status == "In Progress" ? (
                        <TouchableOpacity
                          ...
                          onPress={() =>
                            navigation.navigate("TechJobRequestScreen", {
                              ticket,
                            })
                          }
                        >
  ...
  fetch(global.API_DIRECTORY + global.UPDATE_STATUS, {
    ...
    .then((responseJSON) => {
      if (responseJSON == true) {
        ...
        Alert.alert(
          "Notice",
          "Error: Status was unable to be edited at this time.",
          [{ text: "Ok" }]
        );
      }
    })
